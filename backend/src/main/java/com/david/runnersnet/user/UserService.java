...
import com.david.runnersnet.auth.CustomUserDetailsUser;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) {
        ...
        return new CustomUserDetailsUser(user.getUsername(), user.getPassword(), getAuthorities(), user.getCryptID());
    }
