...
class FeedLoader {
	public function loadDistance($userID, $feed, $feedindex, $diststmt, $db) {
		...
		while ($row = $result->fetch_assoc()) {
			...
			$feed[$feedindex]['date'] = strtotime($row['date']);
	...
	public function loadSpeed($userID, $feed, $feedindex, $speedstmt, $db) {
		...
		while ($row = $result->fetch_assoc()) {
			...
			$feed[$feedindex]['warmup'] = $row['warmup'];
			$feed[$feedindex]['cooldown'] = $row['cooldown'];
			$feed[$feedindex]['workout'] = $row['workout'];
			$feedindex++;
		}
		$db->next_result();
	...
	public function loadRaces($userID, $feed, $feedindex, $racestmt, $db) {
	...
	public function loadPosts($userID, $feed, $feedindex, $poststmt, $db) {
	...
	public function loadPagePosts($userID, $feed, $feedindex, $pgpoststmt, $db) {
	...
	public function loadReposts($userID, $feed, $feedindex, $repoststmt, $db) {
	...
	public function loadFeed($userID, $feed, $feedindex, $speedstmt, $diststmt, $racestmt, $poststmt, $pgpoststmt, $repoststmt, $db, $basicinfo, $groupstmt) {
		...
		while ($row = $result->fetch_assoc()) {
			...
			$feed[$feedindex]['pace'] = $row['pace'];
			$feed[$feedindex]['journal'] = $row['journal'];
			$feed[$feedindex]['firstname'] = $firstname;
			$feed[$feedindex]['lastname'] = $lastname;
			$feed[$feedindex]['theimg'] = $img;
			$feedindex++; 
		}
		$db->next_result();
