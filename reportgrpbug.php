...
<body>
    ...
    if ($call = mysqli_query($db, "CALL GETGROUPINFO($userid)")) {
    ...
    echo "<span>What are you reporting ".$firstname." ".$lastname." for?";
    echo "<form id='reportform' name='reportform' method='post' action='generatereport.php'>";
    echo "<input type='checkbox' name='report1'>Stalking You or Another User<br>";
